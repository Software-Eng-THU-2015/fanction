...
if __name__ == "__main__":
    ...
    """
    thu_learn.login(user_id="2013013295", user_pass="kehk121")
    semester = thu_learn.Semester()
    result = MyEncoder().encode(semester)
    print(result)
    """